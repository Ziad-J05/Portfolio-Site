...
export default function IntroSection(){
  return (
    <>
        <section className="font-(family-name:--display-font) grid grid-cols-[1fr_calc(72*var(--spacing))] grid-auto-rows-auto gap-4 w-3xl mx-auto h-auto mb-16 pt-32">
          ...
          <img
            className="row-start-1 row-end-2 col-start-2 col-end-3 size-72 object-cover border-2 self-end rounded-xl"
